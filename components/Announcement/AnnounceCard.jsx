...
const AnnounceCard = ({ announceData }) => {
  return (
    <div className='flex flex-col bg-white rounded-xl shadow-xl p-4 w-auto lg:w-2/3 my-16'>
      ...
      <div>
       {
        announceData.map((announce) => (
          <>
            ...
            <div key={announce?.id} className='bg-gray-100 px-4 py-2 rounded-xl mt-2 w-full'>
